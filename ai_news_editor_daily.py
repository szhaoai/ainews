...
Generate a daily digest of the most influential AI news.
...
async def main():
    ...
    args.add_argument('--days', type=float, default=1)
    ...
    report = await AINewsEditor().generate_report(max_stories=a.max_stories)
